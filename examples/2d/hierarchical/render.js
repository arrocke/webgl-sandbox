...
if (gl) {
    ...
    module.exports = function render(rotation, translation, scale, width, height, color) {
        ...
        for (var i = 0; i < 5; i++) {
            transformationMatrix = matrix3.multiply(scaleMatrix, transformationMatrix);
            transformationMatrix = matrix3.multiply(rotationMatrix, transformationMatrix);
            transformationMatrix = matrix3.multiply(translationMatrix, transformationMatrix);
